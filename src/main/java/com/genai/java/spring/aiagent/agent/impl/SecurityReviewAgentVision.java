...
public class SecurityReviewAgentVision implements SecurityReviewAgent {
    ...
    private Plan getPlan(String fileName, String id) {
        ...
        String system = """
                ...
                2) called security_posture for each target service;
            ...
            if (message instanceof ToolResponseMessage toolResponseMessage) {
                ...
                for (ToolResponseMessage.ToolResponse toolResponse : toolResponses) {
                    ...
                    if (parsedResponse.isError()) {
                        throw logAndBuild(toolResponseMessage.getMessageType().name(), "MCP_TOOL_ERROR",
                    ...
                    if (error != null && !String.valueOf(error).isEmpty()) {
                        throw logAndBuild(toolResponseMessage.getMessageType().name(), String.valueOf(error),
                                String.valueOf(payload.getOrDefault("message", "")));
                    }
                }
            }
    ...
    private ToolExecutionException logAndBuild(String type, String code, String message) {
